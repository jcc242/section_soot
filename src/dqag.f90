module dqag
  !! This module contains the QUADPACK function 'qag' and dependencies.
  !! I converted the function and dependencies from single precision to double precision.
  !! I also changed the external functions to be function pointers.
